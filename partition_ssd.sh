...
# Partition and format an external SSD for NixOS (UEFI/GPT).
# WARNING: This ERASES ALL DATA on the target disk!
# Run in the NixOS live environment after booting from USB.
...
echo "Formatting root partition as ext4 (label: NixOS)..."
